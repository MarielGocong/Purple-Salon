...
class AppointmentConfirmationNotification extends Notification implements ShouldQueue
{
    ...
    public function toMail($notifiable): MailMessage
    {
        return (new MailMessage)
            ...
            ->line('Your total of ₱ ' . $this->appointment->total )
            ->line('*Disregard if already paid on GCash')
            ...
            ->line('Thank you for using Purple Look Hair Salon and Spa! We hope to see you soon.')
            ->line('If you have questions and clarifications')
